 ...
 * @returns {Object} 検索結果
 */
export function findMeetupDates(positions, meetupStartTime, startDate, endDate) {
  const result = {
    allMatches: [], // 全員参加可能な日
  ...
  while (currentDate.isBefore(endDate)) {
    const dateResults = checkDateForPositions(currentDate, positions, meetupStartTime);
