...
3. `data/`の.csv（`weekday.csv`:平日,`saturday.csv`:土曜,`holiday.csv`:日祝）を編集します。フォーマットは以下のとおりです。
...
4. アプリケーションを起動します。
   ...
   ブラウザで`http://localhost:8000`にアクセスすると、カレンダーが表示されます。
